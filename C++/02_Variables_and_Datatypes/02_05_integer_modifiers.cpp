...
int main()
{
    signed int value1{20}; // The program will work same without signed
    signed value2{-98};
    ...
    unsigned int value3{4}; // Unsigned will only take positive numbers
    // unsigned int value4{-5}; // Compiler error

    // short and long
    short short_var{-345};                      // 2 Bytes
    short int short_int{-35};                   //
    signed short signed_short{45};              //
    signed short int signed_short_int{-345};    //
    unsigned short int unsigned_short_int{345}; //

    int int_var{77};              // 4 Bytes
    signed signed_var{44};        //
    signed int signed_int{55};    //
    unsigned int usigned_int{88}; //

    long long_var{88}; // 4 or 8 bytes
    long int long_int{44};
    signed long signed_long{99};
    signed long int signed_long_int{87};
    unsigned long int unsigned_long_int{34};
    ...
    std::cout << "Unsigned int : " << usigned_int << " , size : "
